...
class PID {
  ...
  update (input, dt = null) {
    ...
    if (this.sampleTime != null && dt < this.sampleTime && this._lastOutput != null) return this._lastOutput
    ...
    const output = clamp(this.proportional + this.integral + this.derivative, this.outputLimits)
